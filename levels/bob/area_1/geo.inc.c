...
const GeoLayout bob_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_TRANSLATE_ROTATE_WITH_DL(1, -1872, 138, -637, 0, 0, 0, bob_dl_Cube_001_mesh),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout bob_area_1[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_CAMERA(CAMERA_MODE_8_DIRECTIONS, 370, -47, 195, 370, -260, 195, geo_camera_main),
				GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(3, bob_dl_material_revert_render_settings),
